...
export default function ShoppingCart({ items, cartItems, handleDelete: onDelete, handleChangeQuantity: onQuntity }) {
              ...
              <div id="cart-item-list">
                {renderItems.map((item, idx) => {
                  ...
                  return <CartItem
                    ...
                    handleQuantityChange={onQuntity}
